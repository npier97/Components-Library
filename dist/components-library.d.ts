...
export declare type InputProps = ComponentProps<"input"> &
...
export declare type ModalProps = ComponentProps<"div"> &
...
export declare type NavProps = ComponentProps<"nav"> &
...
declare const Text_2: ForwardRefExoticComponent<
  Omit<TextProps, "ref"> & RefAttributes<HTMLElement>
>;
